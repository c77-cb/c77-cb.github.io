...
slider.readFileAsDataURL = function(file) {
	...
	reader.onload = function (event) {
		...
		/*document.getElementById("source_holder").style.backgroundImage = url("https://i.imgur.com/GaXYWvW.jpg");*/
	    ...
	    for (var i=0; i<myrules.length; i++){
	    	...
	    	if(myrules[i].selectorText.toLowerCase()==".tile"){
	    		/*myrules[i].style.backgroundImage =url("https://i.imgur.com/GaXYWvW.jpg");*/
